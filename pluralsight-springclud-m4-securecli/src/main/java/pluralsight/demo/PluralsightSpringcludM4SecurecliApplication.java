...
public class PluralsightSpringcludM4SecurecliApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(PluralsightSpringcludM4SecurecliApplication.class, args);
	}
...
System.out.println("cron job started");
		...
		resourceDetails.setUsername("ruhi");
